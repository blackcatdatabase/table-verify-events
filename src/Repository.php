...
use BlackCat\Database\Packages\VerifyEvents\Repository\VerifyEventRepository as GeneratedRepository;
...
{
  private VerifyEventRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof VerifyEventRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected VerifyEventRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\VerifyEvents\Dto\VerifyEventDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\VerifyEvents\Dto\VerifyEventDto|null { return $this->repo->getById($id, $asDto); }
