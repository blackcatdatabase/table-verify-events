...
{
    private VerifyEventRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new VerifyEventRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\VerifyEvents\Dto\VerifyEventDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\VerifyEvents\Dto\VerifyEventDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\VerifyEvents\Dto\VerifyEventDto|null
    {
