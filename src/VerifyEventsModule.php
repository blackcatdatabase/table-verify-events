...
final class VerifyEventsModule implements ModuleInterface
{
    public function name(): string { return 'table-verify_events'; }
    public function table(): string { return 'verify_events'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_ver_ip', 'idx_ver_time', 'idx_ver_type_time', 'idx_ver_user' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_ver_ip', 'idx_ver_time', 'idx_ver_type_time', 'idx_ver_user' ],
            'foreignKeys' => [ 'fk_verify_user' ],
        ];
    }
}
