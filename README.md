...
- Pkg folder: [packages\verify-events](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\verify-events)
...
graph LR
  ...
  verify_events["verify_events"]:::center
  verify_events -->|FK| users["users"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package verify-events -Apply
